@php
function dequy($queryCategory, $parentId, $title)
{
    foreach ($queryCategory as $dataItem) {
        if(($dataItem->findParentCategory != null && $dataItem->findParentCategory->findParentCategory == null) || $dataItem->findParentCategory == null ) {
            if ($dataItem->parent_id == $parentId) {
                echo '<option value="' . $dataItem->id . '">' . $title . $dataItem->name . '</option>';
                dequy($queryCategory, $dataItem->id, $title . '...');
            }
        }
    }
}
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <form action="{{ route('categoryjob.store') }}" method="post">
                                @csrf
                                <div class="row">
