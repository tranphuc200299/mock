<!-- Modal -->
<div class="modal fade" id="model_confirm_job" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body" style="padding: 2rem">
                ...
                <div class="job-content mt-3">
                    ...
                    <div class="d-flex">
                        <p class="label-column">break time</p>
                        <p class="detail-break-time"></p>
                    </div>
                    <div class="d-flex">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-primary btn-save btn-save-job ml-3" id="btn-add-update-job">SAVE</button>
                    </div>
                </div>
            </div>
        </div>
